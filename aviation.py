...
if __name__ == "__main__":
    ...
    show_data_list(base_url, data_url, ['定期航班航线里程', '国际航线线路长度', '民用航空国内航线航线里程', '民用航空港、澳地区航线里程'],
                   title="航班航线里程")
    show_data_list(base_url, data_url, ['民用飞机架数', '民用运输飞机架数'], title="民用飞机架数")
    show_data_list(base_url, data_url, ['民用大中型运输飞机架数', '民用大中型波音747运输飞机架数', '民用大中型波音737运输飞机架数',
                                        '民用大中型波音757运输飞机架数', '民用大中型波音767运输飞机架数',
                                        '民用大中型MD90运输飞机架数', '民用大中型MD82运输飞机架数', '民用大中型A320运输飞机架数'],
                   title="民用大中型运输飞机架数")
    show_data_list(base_url, data_url, ['民用小型运输飞机架数', '民用小型ARJ21-700运输飞机架数', '民用通用飞机架数',
                                        '民用教学校验飞机架数'], title="民用小型运输飞机架数")
